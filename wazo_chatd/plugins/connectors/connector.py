...
class Connector(Protocol):
    ...
    def send(self, message: OutboundMessage) -> str:
        ...
        Idempotency (optional):
            ...
            backend supports idempotent requests (e.g. Twilio's
    ...
    def verify_signature(self, data: TransportData) -> bool:
        ...
        For webhook-based backends, implement HMAC verification
    ...
    def on_event(cls, data: TransportData) -> InboundMessage | StatusUpdate | None:
        ...
        Idempotency (optional):
            If the backend supplies an idempotency key, include it in
    ...
    def scan_inbound(self) -> list[InboundMessage]:
        ...
        longer than the backend HTTP timeout.
